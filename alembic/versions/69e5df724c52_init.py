...
Revision ID: 69e5df724c52
Revises: 
Create Date: 2024-01-03 15:45:55.081596
...
def upgrade() -> None:
    ...
    sa.Column('student_address', sa.String(length=150), nullable=False),
    ...
    sa.Column('date_mark', sa.DateTime(), nullable=False),
